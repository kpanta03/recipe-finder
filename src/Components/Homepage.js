    ...
    <>
      <div className="container-fluid my-lg-5 page1">
        <div className="row">
          <div className=" col-12 col-lg-7 px-3 py-lg-5 py-3">
            <h3 className="font1 page1_heading"> Discover Delicious Recipes At your fingertips-search,filter,and savor
              the flavours you love!</h3>
      ...
      <div className="page2 container-fluid">
        ...
        <div className="container text-center page2_content">
          ...
          <p className="font2 page2_para">Welcome to Recipe Finder, your ultimate destination for discovering
            mouthwatering recipes tailored to your ingredients and preferences. Our mission is to make cooking
            easier and more enjoyable by bringing you a curated collection of recipes from around the world. Whether
            you're a seasoned chef or a beginner, Recipe Finder empowers you to explore, filter, and find the
            perfect dish for every occasion. Join us on this flavorful journey and let’s make cooking a delightful
            experience!</p>
      ...
      <div className=" container-fluid page3">
        ...
        {/* <!-- see more --> */}
        <div class="text-center mb-4" style={{ marginTop: "-2rem" }}>
          <button class="btn button" onClick={() => navigate('/recipes')}>See more</button>
        </div>
      </div>
